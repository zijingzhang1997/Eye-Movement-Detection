...
Mean22 = mean(br_rog - br_eog);
std22 = std(br_rog - br_eog);
[r22,p1] = corrcoef(br_rog,br_eog); 
r22 = r22(1,2);

result.mean_eog=mean1;result.std_eog=std1;result.r_eog=r1;
result.mean_rog=mean2;result.std_rog=std2;result.r_rog=r2;
result.mean_re=Mean22;result.std_re=std22;result.r_re=r22;
...
result.max_coef=max_coef;
result.max_r=max_r;




save([savePath,'fig_REM_paper\','matFile\',ExpDate,fileName,'result_EMfreq.mat'],'result','tOff','br_rog','br_rog2','fsDS','br_eog','EM_f','opts3','Motion','br_opt2_data','br_opt1_data');
%%
